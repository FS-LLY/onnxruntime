...
lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer=optimizer, step_size=30,gamma=0.5,last_epoch=-1)
...
vaildloader = torch.utils.data.DataLoader(validset, batch_size=batch_size,
